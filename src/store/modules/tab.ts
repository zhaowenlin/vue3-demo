...
class Tab extends VuexModule {
  ...
  // tab list
  tabsState: RouteLocationNormalizedLoaded[] = [];
  ...
  get getCurrentTab(): RouteLocationNormalizedLoaded {
  ...
  @Mutation
  commitTabRoutesState(route: RouteLocationNormalizedLoaded) {
  ...
  @Action
  addTabAction(route: RouteLocationNormalizedLoaded) {
  ...
  @Action
  closeTabAction(tab: RouteLocationNormalizedLoaded) {
    function getObj(tabItem: RouteLocationNormalizedLoaded) {
  ...
  @Action
  closeLeftTabAction(route: RouteLocationNormalizedLoaded): void {
  ...
  @Action
  closeRightTabAction(route: RouteLocationNormalizedLoaded): void {
  ...
  @Action
  closeOtherTabAction(route: RouteLocationNormalizedLoaded): void {
